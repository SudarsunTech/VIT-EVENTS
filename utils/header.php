    ...
    <nav class="navbar" >
        ...
        <div class="navbar-header">
                ...
                <a class = "navbar-brand">
                   <h2><img src="https://iqac.vit.ac.in/images/vit-logo-only.png" alt="vit log" style="width:115xpx;height:87px;">
                   VIT - Chennai </h2>
                </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href = "suggestions.php"><strong>Suggestions</strong></a></li>
